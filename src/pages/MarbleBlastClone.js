...
import MarbleBlastCloneVideo from '../resources/MarbleBlastClone_AdobeExpress.mp4'

function MarbleBlastClone() {
    return (
        <Grid container spacing={4} style={{overflow: 'hidden', margin: 'auto', minHeight: '100vh', width: '95vw'}}>
            <Grid item xs={8}>
               <video src={MarbleBlastCloneVideo} autoPlay loop muted style={{height: 'auto', width: '100%'}} type="video/mp4"/> 
            </Grid>
            <Grid item xs={4}>
                <Container>
